class DbExercisesController < ApplicationController
  #Gets ALLLLLLL The exercises from the ExerciseDB API. Too many api calls. Only use if really needed
  # def index
  #   all_exercises = HTTP.headers("X-Rapidapi-Key" =>Rails.application.credentials.exercise_api_key).get("https://exercisedb.p.rapidapi.com/exercises").parse(:json)
    
  #   render json: all_exercises
  # end

  #This can make a single exercise in db_exercises
  # def create
  ...
  #   end   
  # end
#This will make all the exercises in the DB_Exercises
  def create_exercises
    #all_exercises array has ALL the database entries from the ExerciseDB API. 
    #It's 10k lines long. 
      all_exercises = [
  {
    "bodyPart": "waist",
  ...
  },
  {
    ...
    #   i = 0
    #   all_exercises.each do 
    #   DbExercise.create({
    #     bodyPart: all_exercises[i][:bodyPart],
    #     gifUrl: all_exercises[i][:gifUrl],
    #     equipment: all_exercises[i][:equipment],
    #     exerciseDB_id: all_exercises[i][:id],
    #     name: all_exercises[i][:name],
    #     target: all_exercises[i][:target],
    #     })
    #    i +=1
    # end
    
  #   if DbExercise.create
  #     render json: { message: "exercises created successfully" }, status: :created
  #   else
  #     render json: { errors: all_exercises.errors.full_messages }, status: :bad_request
  #   end
  # end
